(function ($) {
    ...
    var crsBasic = function () {
        if ($('#map-panes').length) {
            ...
            var positronLabels = L.tileLayer('../../../../../../../{s}.basemaps.cartocdn.com/light_only_labels/{z}/{x}/{y}.png'/*tpa=http://{s}.basemaps.cartocdn.com/light_only_labels/{z}/{x}/{y}.png*/, {
                attribution: cartodbAttribution,
                pane: 'labels'
            }).addTo(map);
    ...
    var MultiMark = function () {
        if ($('#map-multi-mark').length) {
            ...
            leaflet.addLayer(new L.TileLayer('../../../../../../../{s}.tile.openstreetmap.org/{z}/{x}/{y}.png'/*tpa=http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png*/));
